...
-->
# 💫 About Me:
🔭 I’m currently working on hands-on projects in cloud infrasture, python development and basic cloud automation using AWS and OCI.<br>👯 I’m looking to collaborate on beginner-friendly cloud, Python, networking or DevOps projects solving real-world problem solving.<br>🤝 I’m looking for help with cloud automation, infrastructure design best practices and moving from labs to production-style projects.<br>🌱 I’m currently learning cloud computing, Python, Linux administration, network fundamentals and generative AI concepts<br>💬 Ask me about OCI basic, AWS cloud fundamental, Python for beginners, Linux commands and networking concepts.<br>⚡ Fun fact, I end up breaking systems just to undrstand how to build them better 😄
